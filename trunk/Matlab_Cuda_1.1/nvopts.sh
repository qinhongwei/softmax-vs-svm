...
#			CFLAGS="$CFLAGS -gencode=arch=compute_13,code=sm_13 -gencode=arch=compute_20,code=sm_20"
...
#----------------------------------------------------------------------------
            ...
            CFLAGS="$CFLAGS -m64 -O3 -gencode=arch=compute_20,code=sm_20 -gencode=arch=compute_35,code=sm_35"    #CT 7.2011 only for fermi architectures and 1.x, with no PTX JIT support for future versions
#           CFLAGS="$CFLAGS -m64 -O3 -gencode=arch=compute_13,code=sm_13 -gencode=arch=compute_20,code=sm_20"             #sm_13 needed for guppy1-3, But, conv can't compile double mode!
